"""
This script is for using simulated fst data to 
classify migration levels using a support vector machine.
"""
...
data = pd.read_csv('fst_sim_data.txt', sep='\t')
...
plt.savefig('/Users/jeremiahmushtaq/Documents/University/MSc Research Project/confusion_matrix_svm.png')
...
metrics_file_name = 'metrics_svm.tsv'
